...
ActiveRecord::Schema[8.2].define(version: 2026_01_01_000006) do
  ...
  create_table "ai_usage_events", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_ai_usage_events_on_created_at"
    t.index ["feature"], name: "index_ai_usage_events_on_feature"
  end
